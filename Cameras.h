...
#include <GLFW/glfw3.h>
	...
	public:
		inline void setProjection(float left, float right, float bottom, float top, float zNear, float zFar) {
	...
	public:
		inline void kbCallBack(GLFWwindow* window, int key, int scancode, int action, int mods) {}
